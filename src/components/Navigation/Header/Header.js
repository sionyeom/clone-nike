    ...
    <>
      ...
      <div className="header">
        ...
        <div className="menues_container">
          <ul className="menues">
            <li onMouseOver={() => {mouseovernav(1)}} onMouseOut={() => {mouseoutnav()}}>New Releases</li>
            <li onMouseOver={() => {mouseovernav(2)}} onMouseOut={() => {mouseoutnav()}}>Men</li>
            <li onMouseOver={() => {mouseovernav(3)}} onMouseOut={() => {mouseoutnav()}}>Women</li>
            <li onMouseOver={() => {mouseovernav(4)}} onMouseOut={() => {mouseoutnav()}}>Kids</li>
            <li onMouseOver={() => {mouseovernav(5)}} onMouseOut={() => {mouseoutnav()}}>Sale</li>
            <li>SNKRS</li>
          </ul>
        </div>
      ...
      {(isNavHover==1 || isDropDownHover==1) && <DropDownMenu setIsDropDownHover={setIsDropDownHover} setNavListNum={setNavListNum} navListNum={navListNum}/>}
